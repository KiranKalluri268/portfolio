...
const styles = StyleSheet.create({
  ...
  headline: { fontFamily: "Times-Bold", fontSize: 10.5, color: "#444444", marginBottom: 5 },
  ...
  entryTitle: { fontFamily: "Times-Bold", fontSize: 10.5, flex: 1, paddingRight: 8 },
  entryMeta: { fontFamily: "Times-Italic", fontSize: 8.5, color: "#444444" },
  entrySubtitle: { fontFamily: "Times-Bold", fontSize: 9.5, color: "#333333", marginTop: 1 },
  ...
  workItemTitle: { fontFamily: "Times-Bold", fontSize: 9.5 },
  kind: {
    marginLeft: 5,
    color: "#555555",
    fontFamily: "Times-Bold",
  ...
  quoteText: { fontFamily: "Times-Italic" },
