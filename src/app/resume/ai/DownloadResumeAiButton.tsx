...
export default function DownloadResumeAiButton({
  internships,
  projects,
  skillGroups,
}: {
  ...
  const downloadPdf = async () => {
    ...
    try {
      const [{ pdf }, { default: ResumeAiPdfDocument }] = await Promise.all([
        import("@react-pdf/renderer"),
        import("./ResumeAiPdfDocument"),
      ]);
      const blob = await pdf(<ResumeAiPdfDocument internships={internships} projects={projects} skillGroups={skillGroups} />).toBlob();
      ...
      anchor.href = url;
      anchor.download = "Saikiran-Kalluri-AI-ML-Resume.pdf";
  ...
  return (
    <button
      ...
      aria-label="Download AI/ML resume as a PDF"
    >
